...
public class Main {
    ...
    public static void main(String[] args) {
      // tipe data di java:
        ...
        System.out.println("Besar integer = " + Integer.TYPE + " bytes");
        ...
        System.out.println("Besar byte = " + Byte.TYPE + " bytes");
        ...
        System.out.println("Besar short = " + Short.TYPE + " bytes");
        ...
        System.out.println("Besar long = " + Long.TYPE + " bytes");
        ...
        System.out.println("Besar double = " + Double.TYPE + " bytes");
        ...
        System.out.println("Besar float = " + Float.TYPE + " bytes");
        ...
        System.out.println("Besar char = " + Character.TYPE + " bytes");
